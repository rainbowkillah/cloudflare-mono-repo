...
```jsonc
{
  ...
  "kv_namespaces": [
    { "binding": "KV", "id": "tenant-specific-id" }
  ],
  "durable_objects": {
    "bindings": [
  ...
  "services": [
    { "binding": "VECTORIZE", "service": "vectorize" }
  ]
}
```
...
*Unblocks: Phase 1 (all tasks)*  
*Review gate: Full team consensus required for any change to these decisions*
